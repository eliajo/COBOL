...
public class QuizActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        if(fragment.getClass().equals(Questions3.class) && findViewById(R.id.chipYesSideEffects).isSelected()&&findViewById(R.id.textView11).getVisibility()==View.VISIBLE){
            //findViewById(R.id.chipYesSideEffects).setSelected(false);
        ...
        } else if(fragment.getClass().equals(Questions2.class) && findViewById(R.id.chipNo).isSelected()&&findViewById(R.id.textView10).getVisibility()==View.VISIBLE){
           // findViewById(R.id.chipNo).setSelected(false);
            findViewById(R.id.textView10).setVisibility(View.GONE);
            findViewById(R.id.sideeffectsRadiobutton).setVisibility(View.GONE);
    ...
    public static boolean isComplementaryQuestionForPageAnswered(int pageNumber){
            ...
            if (pageNumber==2){
                ...
                return QuizAnswers.stream().anyMatch(o -> o.getQuestionId()==10 && (Boolean) o.getData()==true);
            }
            return false;
        }
    }
